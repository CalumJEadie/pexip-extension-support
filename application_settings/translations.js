 ...
 *
 * This language code MUST be included in window.PEXIP_TRANSLATIONS below
 */
window.PEXIP_TRANSLATIONS_PREFERRED_LANGUAGE = 'en';
 ...
 *
 * You must include ALL translations in at least one translation object.
 * This way, these will be the default values when you do not include a translation.
 *
 * This line must be uncommented to work:
 */
// window.PEXIP_TRANSLATIONS_FALLBACK_LANGUAGE = 'en';
 ...
 *
 * PEXIP_TRANSLATIONS may contain any number of language code to translation mappings.
 *
 * Use the format:
 *
 *   'en': {
 *      TRANSLATION_KEY: 'Your text goes here'
 *   }
 *
 * HTML markup or entities will be escaped (you will end up with &amp; &lquot; text)
 *
 */
window.PEXIP_TRANSLATIONS = {
	'en': {
